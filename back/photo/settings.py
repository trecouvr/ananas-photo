...
config = getconf.ConfigGetter('photo', ['./local_settings.ini'])

ENV = config.getstr('photo.env')
FRONT_URL = config.getstr('photo.front_url')

MAINTENANCE = config.getbool('photo.maintenance', False)
...
SITE_URL = config.getstr('photo.site_url', '')
